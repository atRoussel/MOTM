...
export class StatisticsComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.surveyService.getSurveys().subscribe(surveys => {
            ...
            // Calcul de la moyenne de la question générale pour chaque sondage
    ...
    // Affecter le bon émoji selon la valeur de la moyenne
    ...
    // Identifier le sondage que l'on souhaite afficher
    selectChangeHandler(event: any) {
        ...
        // Actualisation des données selon le sondage choisi
        this.getAverageMainResponses();
        this.getMainComments();
        this.graphDatas();
        this.lineGraph();
    ...
    // Calcul de le moyenne obtenue pour chaque question d'un sondage
    ...
    getMainComments() {
        this.mainComments = [];
        this.mainSurvey.comments.forEach(com => {
            if (com.value !== '') {
                this.mainComments.push(com.value)
            }
        });
    }

    // Graphique de l'historique de la moyenne obtenue pour chaque sondage
    lineGraph() {
    ...
    // Graphique du nombre de votes obtenus par question pour le sondage choisi
    graphDatas() {
        this.count1 = 0;
        this.count2 = 0;
        this.count3 = 0;
