...
3. Pour les fichiers `1_TABLES.sql` et `2_DEFAULT_ENTRIES.sql` faites respectivement : Clique droit sur le fichier > Run > Ajouter defaultdb dans _**Target data source / schema**_ (icone +) > Run
